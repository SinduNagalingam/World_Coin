...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-par=<n>", strprintf(_("Set the number of script verification threads (%u to %d, 0 = auto, <0 = leave that many cores free, default: %d)"),
        -GetNumCores(), MAX_SCRIWCNHECK_THREADS, DEFAULT_SCRIWCNHECK_THREADS));
#ifndef WIN32
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/worldcoin-project/worldcoin>";
    const std::string URL_WEBSITE = "<https://worldcoin.org>";
...
bool AppInitParameterInteraction()
{
    ...
    nScriptCheckThreads = gArgs.GetArg("-par", DEFAULT_SCRIWCNHECK_THREADS);
    if (nScriptCheckThreads <= 0)
        nScriptCheckThreads += GetNumCores();
    if (nScriptCheckThreads <= 1)
        nScriptCheckThreads = 0;
    else if (nScriptCheckThreads > MAX_SCRIWCNHECK_THREADS)
        nScriptCheckThreads = MAX_SCRIWCNHECK_THREADS;
