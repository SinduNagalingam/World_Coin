...
{
    const char* pszTimestamp = "BBC NEWS 03/Sep/2018 Flying lava injures 23 in Hawaii";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1535970635, 2086444274, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8c4ab95c9f7729dc3877fd5ab0fb8c4806194bbb7fddc58fc078070b81aa592a"));
        assert(genesis.hashMerkleRoot == uint256S("0x0b232515b0b7fbe77eea22b37aae5aa52cc5e81b782d37cc9d4b8e460c263109"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("167.99.157.234:62458", true);
        vSeeds.emplace_back("206.81.12.144:62458", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.worldcointools.com", true);
        vSeeds.emplace_back("seed-b.worldcoin.loshan.co.uk", true);
