...
* Update manpages, see [gen-manpages.sh](https://github.com/worldcoin-project/worldcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Build and sign worldcoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.ltc/ ../worldcoin/contrib/gitian-descriptors/gitian-win.yml
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`worldcoin-${VERSION}-osx-unsigned.dmg`, `worldcoin-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import worldcoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer worldcoin-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [worldcoin-detached-sigs](https://github.com/worldcoin-project/worldcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.

Create (and optionally verify) the signed OS X binary:

    pushd ./gitian-builder
    ./bin/gbuild -i --commit signature=v${VERSION} ../worldcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.ltc/ ../worldcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.ltc/ ../worldcoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-win-signed ../worldcoin/contrib/gitian-descriptors/gitian-win-signer.yml
...
- Announce the release:
  ...
  - worldcoin-dev and worldcoin-dev mailing list

  - blog.worldcoin.org blog post
  ...
  - Create a [new GitHub release](https://github.com/worldcoin-project/worldcoin/releases/new) with a link to the archived release notes.
